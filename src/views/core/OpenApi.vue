<!--
 * @OpenApiPath     : /wizjs_vue_example/src/views/core/OpenApi.vue
...
@Options({ name: "OpenApi", components: { AppBar } })
export default class OpenApi extends Vue {
  router = useRouter();
  testRes = "";

  created(): void {
    console.log("OpenApi created");
